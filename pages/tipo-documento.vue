<template>
  <div class="center no-padding divcol" style="margin-bottom:20px; padding-left: 256px;">
    <section class="section1-tipo-documento">
      <div class="datos-tipo-documento-container">
        <div class="title-morado">
          <p class="datos-tipo-documento-title">
            Tipo de Documento
          </p>
          ...
          >
            ...
            <v-card id="dialog-editar-crear">
              <v-card-title>
                <span class="title">Crear Nuevo Tipo de Documento</span>
              </v-card-title>
          ...
          >
            <v-card id="dialog-editar-crear">
              <v-card-title>
                <span class="title">Editar Tipo de Documento</span>
              </v-card-title>
  ...
  methods: {
    getData() {
      this.$axios.$get('tipodocumento').then(response => {
          this.tipoDocumentoData = response
        }).catch(err => {
          console.log(err)
        })
    },
...
<style src="~/assets/styles/pages/tipo-documento.scss" lang="scss" />