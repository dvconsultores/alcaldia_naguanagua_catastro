...
export default {
  ...
  methods: {
    ...
    createData(){
      ...
      this.$axios.$post('estatusinmueble/', data).then(res => {
          console.log(res.data)
          this.codigo = ''
          this.descripcion = ''
          this.$alert("success", {desc: "Se ha creado un nuevo estatus de inmueble con éxito", hash: 'knsddcssdc', title:'Creación de estatus de Inmueble'})        
        }).catch(err => {
          console.log(err)
        })
    ...
    saveData(){
      ...
      this.$axios.$patch('estatusinmueble/'+ this.defaultItem.id + '/', formData).then((res) => {
        console.log(res.data)
        this.$alert("success", {desc: "Se ha editado un estatus de inmueble con éxito", hash: 'knsddcssdc', title:'Edición de estatus de inmueble'})        
      }).catch((err) => {
        console.log(err)
      });
    ...
    deleteItem(){
      this.$axios.$delete('estatusinmueble/'+ this.defaultItem.id + '/').then((res) => {
        ...
        this.$alert("success", {desc: "Se ha eliminado un estatus de inmueble con éxito", hash: 'knsddcssdc', title:'Eliminación de estatus de inmueble'})        
      }).catch((err) => {
        console.log(err)
      });
    },
