...
export default {
  ...
  methods: {
    ...
    createData(){
      ...
      this.$axios.$post('regimen/', data).then(res => {
          console.log(res.data)
          this.codigo = ''
          this.descripcion = ''
          this.$alert("success", {desc: "Se ha creado un nuevo régimen con éxito", hash: 'knsddcssdc', title:'Creación de régimen'})        
        }).catch(err => {
          console.log(err)
        })
    ...
    saveData(){
      ...
      this.$axios.$patch('regimen/'+ this.defaultItem.id + '/', formData).then((res) => {
        console.log(res.data)
        this.$alert("success", {desc: "Se ha editado un régimen con éxito", hash: 'knsddcssdc', title:'Edición de régimen'})        
      }).catch((err) => {
        console.log(err)
      });
    ...
    deleteItem(){
      this.$axios.$delete('regimen/'+ this.defaultItem.id + '/').then((res) => {
        ...
        this.$alert("success", {desc: "Se ha eliminado un régimen con éxito", hash: 'knsddcssdc', title:'Eliminación de régimen'})        
      }).catch((err) => {
        console.log(err)
      });
    },
