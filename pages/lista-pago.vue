  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: 'Estado Cuenta #', align: 'center', value: 'liquidacion.estadocuenta.numero'},
        { text: 'Pre-factura #', align: 'center', value: 'liquidacion.numero'},
        { text: 'Recibo #', align: 'center', value: 'numero'},
        { text: 'Fecha', value: 'fecha', align: 'center' },
        { text: 'Inmueble', value: 'liquidacion.inmueble.numero_expediente', align: 'center' },
        { text: 'Propietario', value: 'liquidacion.propietario.nombre', align: 'center' },
        { text: 'Trámite', value: 'liquidacion.tipoflujo.descripcion', align: 'center' },
