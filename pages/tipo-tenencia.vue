...
export default {
  ...
  methods: {
    ...
    createData(){
      ...
      this.$axios.$post('tipotenencia/', data).then(res => {
          console.log(res.data)
          this.codigo = ''
          this.descripcion = ''
          this.$alert("success", {desc: "Se ha creado un nuevo tipo tenencia con éxito", hash: 'knsddcssdc', title:'Creación de tipo tenencia'})        
        }).catch(err => {
          console.log(err)
        })
    ...
    saveData(){
      ...
      this.$axios.$patch('tipotenencia/'+ this.defaultItem.id + '/', formData).then((res) => {
        console.log(res.data)
        this.$alert("success", {desc: "Se ha editado un tipo tenencia con éxito", hash: 'knsddcssdc', title:'Edición de tipo de tenencia'})        
      }).catch((err) => {
        console.log(err)
      });
    ...
    deleteItem(){
      this.$axios.$delete('tipotenencia/'+ this.defaultItem.id + '/').then((res) => {
        ...
        this.$alert("success", {desc: "Se ha eliminado un tipo tenencia con éxito", hash: 'knsddcssdc', title:'Eliminación de tipo tenencia'})        
      }).catch((err) => {
        console.log(err)
      });
    },
