    ...
    <section class="section2-actualizacion">
      ...
      <div class="direccion-container">
        ...
        <div class="direccion-inputs-container">
          ...
          <v-autocomplete v-model="inmuebleData.zona" class="big-autocomplete mobile-inputs" label="Zona"
            :items="dataZona" item-text="descripcion" item-value="id"></v-autocomplete>

          <v-text-field v-model="inmuebleData.anio" class="small-input mobile-inputs" label="Año inicio deuda"
            :disabled="!accesos.borrar"></v-text-field>

          <v-autocomplete v-model="inmuebleData.periodo" class="big-autocomplete mobile-inputs"
            label="Periodo inicio deuda*" :items="periodoData" item-text="periodo" item-value="id"
...
export default {
  ...
  methods: {
    ...
    async  generarPDF() {
      ...
      const qrData = 'URL de certificación Alcaldía de Naguanagua';
      ...
      data = [[(this.inmuebleData.referencia !== 'nan' && this.inmuebleData.referencia !== 'null' && this.inmuebleData.referencia !== null) ? this.inmuebleData.referencia : ' ']];
      pdf.autoTable({
        ...commonOptions,
        headStyles: { fillColor: (255, 192, 203), textColor: (255, 0, 0), cellPadding: 1, halign: 'left' },
        bodyStyles: { textColor: (255, 0, 0), cellPadding: 1, halign: 'left' },
      ...
      let longText = "El suscrito Director(a) de la dirección de catastro de la Alcaldía Bolivariana de Naguanagua del Estado Carabobo, hace constar que el (los) ciudadano(s) [Contribuyentes]"
      ...
      longText = "YO, [Contribuyentes] Declaro que son ciertos los datos plasmados en el presente documento."
      textLines = pdf.splitTextToSize(longText, maxWidth);
      textLines.forEach((line) => {
        pdf.text(15, startY, line);
        startY += 4;
      ...
      startY = startY + 5
      longText = "ESTA ADMINISTRACION SE RESERVA EL DERECHO A INSPECCIONAR EL INMUEBLE EN CUALQUIER MOMENTO CON POSTERIORIDAD A LA EMISIÓN DE LA CÉDULA CATASTRAL O CERTIFICADO DE EMPADRONAMIENTO, "
