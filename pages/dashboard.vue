    ...
    <section class="section1-dashboard">
      ...
      <div class="consultar-card-container">
        <div class="consulta-inputs-container">
          ...
          <div class="divrow inputs-btn-container">
            <v-autocomplete :items="items" class="autocomplete-field"></v-autocomplete>

            <v-text-field class="inputs-consulta" label="Cédula"></v-text-field>

            <v-text-field class="inputs-consulta" label="Nombre o Apellido"></v-text-field>
      ...
      <div class="accesos-rapidos-container">
        ...
        <div class="cards-add-menu-container">
          <v-card v-for="(item, index) in quickAccess" :key="index" class="cards-acceso-rapido"
