<template>
  <div class="center no-padding divcol" style="margin-bottom:20px; padding-left: 256px;">
    <section class="section1-tipo-especial">
      <div class="datos-tipo-especial-container">
        <div class="title-morado">
          <p class="datos-tipo-especial-title">
            Tipo Especial
          </p>
          ...
          >
            ...
            <v-card id="dialog-editar-crear">
              <v-card-title>
                <span class="title">Crear Nuevo Tipo Especial</span>
              </v-card-title>
          ...
          >
            <v-card id="dialog-editar-crear">
              <v-card-title>
                <span class="title">Editar Tipo Especial</span>
              </v-card-title>
  ...
  methods: {
    getData() {
      this.$axios.$get('tipoespecial').then(response => {
          this.tipoespecialData = response
        }).catch(err => {
          console.log(err)
        })
    },
...
<style src="~/assets/styles/pages/tipo-especial.scss" lang="scss" />